...
%Edited by: Rajkumar Conjeevaram Mohan
...
layer{3}.S{1} = ones(N2*M2,N1*M1);
layer{4}.S{2} = ones(N2*M2,N1*M1);
...
layer{3}.delay{1} = ones(N2*M2,N1*M1)*D;
layer{4}.delay{2} = ones(N2*M2,N1*M1)*D;
