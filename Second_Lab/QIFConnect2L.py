...
def QIFConnect2L(N0, N1):
  ...
  net.layer[0].vc = -50 + 15*(r**2)
  net.layer[0].R = R * np.ones(N0)
  net.layer[0].Tau = Tau * np.ones(N0)
  ...
  net.layer[1].vc = -50 + 15*(r**2)
  net.layer[1].R = R * np.ones(N1)
  net.layer[1].Tau = Tau * np.ones(N1)
